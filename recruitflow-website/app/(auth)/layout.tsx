...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-white via-zinc-50 to-zinc-100 px-4 py-12">
      {/* Subtle top glow echoing the site's new design language */}
      <div
        aria-hidden="true"
      ...
      <div className="relative w-full max-w-md">
        <Link
          href="/"
          className="mb-7 mr-2 block text-center transition-opacity hover:opacity-80"
        ...
        <p className="mt-8 text-center text-xs leading-relaxed text-zinc-500">
          ...
          <span className="text-zinc-400">Powered by BranDive Media Solutions</span>
        </p>
      </div>
    </div>
  );
